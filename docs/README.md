...
|-------|----------------|
| [Error collection](./guides/error-collection.md) | Fingerprinting, dedup, GitHub issues, priority labels |
| [Budgets & circuit breakers](./guides/budgets-and-circuit-breakers.md) | 4 layers of cost protection, per-invocation limits |
| [Cost protection](./guides/cost-protection.md) | The $4,868 story and how cf-monitor prevents it |
| [Worker discovery](./guides/worker-discovery.md) | Auto-discovery via CF API, exclude patterns |
...
- [Changelog](../CHANGELOG.md) — version history (v0.1.0 to v0.3.5)
